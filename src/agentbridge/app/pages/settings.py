...
def settings_page_content():
    ...
    with page_scaffold():
        with page_frame():
            ...
            me.text(
                "Configure your API key and output options below.",
                style=me.Style(
                    text_align="center",
                    color=me.theme_var("on-background"),
                    font_size="15px",
                    margin=me.Margin(bottom=26),
                ),
            )
            ...
            with me.box(
                ...
                #     style=me.Style(width='400px', font_size="14px", font_family="inherit"),
                #     multiple=True,
                #     appearance='outline',
