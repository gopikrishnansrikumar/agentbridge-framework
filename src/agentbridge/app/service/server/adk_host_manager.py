...
from supervisors.delegator.agent import HostAgent
from supervisors.delegator.remote_agent_connection import (
    TaskCallbackArg,
)
...
class ADKHostManager(ApplicationManager):
    ...
    def add_event(self, event: Event):
        ...
        print(f"Current events: {list(self._events.keys())}")
